'''
.mpl file format for SigmaMPL2015R2.0 Manual, Data file version YET TO CHECK
'''
# import
import numpy as np
...
wanted_keylst = [
    ...
    'DataFileVersion',          # version YET TO CHECK
    ...
    'Header Size',              # YET TO CHECK,size of data before the channels
...
dtype_dic = {
    ...
    'Polarization Voltage #0':np.float32,
    'Polarization Voltage #1':np.float32,
...
bytesize_dic = {
    ...
    'Elevation Angle':4,
    'Compass Degrees':4,
    'Polarization Voltage #0':4,
    'Polarization Voltage #1':4,
    'GPS Latitude':4,
    'GPS Longitude':4,
    'GPS Altitude':4,
    'A/D Data Bad flag':1,
    ...
    'Channel #2 Data':0      # 798 -> 75m binsize
}
